...
Ext.define('FeedViewer.FeedDetail', {
    ...
    createTopToolbar: function(){
        this.toolbar = Ext.create('widget.toolbar', {
            ...
            items: [{
                ...
                pressed: false,
                scope: this,
                handler: this.onNewFeedbackClick
            }, {
                iconCls: 'tab-new',
                text: 'My Profile',
                enableToggle: false,
                pressed: false,
                scope: this,
                handler: this.onEditProfileClick
            }, {
                iconCls: 'tab-new',
                text: 'Logout',
                enableToggle: false,
    ...
    onEditProfileClick: function(){
        ...
        var profile_win = this.addProfileWindow || (this.addProfileWindow = Ext.create('widget.myprofile', {
        }));
        profile_win.form.getForm().reset();
        profile_win.show();
    },
     ...
     * @private
     */
    onNewFeedbackClick: function(){
			console.log("NewFeedback");
        var feedback_win = this.addFeedbackWindow || (this.addFeedbackWindow = Ext.create('widget.feedback', {
        }));
        feedback_win.form.getForm().reset();
        feedback_win.show();
    },		
